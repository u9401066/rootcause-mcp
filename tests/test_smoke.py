...
@pytest.mark.asyncio
async def test_thinking_handler_basic():
    """Test basic thinking handler functionality."""
    handler = ThinkingHandlers()
    
    result = await handler.handle("rc_think_aloud", {
